...
const question_ber = document.getElementById('question_ber') as HTMLElement;
const quiz_area = document.getElementById('quiz_area') as HTMLElement;
const question_area = document.getElementById('question_area') as HTMLElement;
const modeSelect = document.getElementById('modeSelect') as HTMLElement;
const button_area = document.getElementById('button_area') as HTMLElement;
const label1 = document.getElementById('label1') as HTMLElement;
const label2 = document.getElementById('label2') as HTMLElement;
const label3 = document.getElementById('label3') as HTMLElement;
const label4 = document.getElementById('label4') as HTMLElement;
const result = document.getElementById('result') as HTMLElement;
const button = document.getElementById('resultOrNextButton') as HTMLButtonElement;
const resetButton = document.getElementById('resetButton') as HTMLButtonElement;
const resultButton = document.getElementById('resultButton') as HTMLButtonElement;
const openButton = document.getElementById('openButton') as HTMLButtonElement;
const closeButton = document.getElementById('closeButton') as HTMLButtonElement;
const tips = document.getElementById('tips') as HTMLDialogElement;
let special:boolean;
let badEnd:boolean = false;
...
//正解リスト
const correct_answer_list:string[] = [
    "4", "1", "1", "4", "2", "3", "4", "1", "2", "4",
    "1", "3", "1", "2", "3", "1", "2", "4", "3", "2",
    "4", "1", "2", "1", "2", "3", "3", "2", "1", "3",
    "2", "3", "4", "1", "1", "2", "2", "3", "1", "2",
...
let question_count:number = 0;
let question_count_max:number = question_list.length;
let resultMode:boolean = true;

//ラジオボタンの選択肢を取得
window.addEventListener('DOMContentLoaded', function () {
    let input_answers = document.querySelectorAll<HTMLInputElement>("input[name=answer]");
    input_answers.forEach(element => {
...
function answerCheck():void {
    ...
    // 回答後は選択不可にする
    input_answers.forEach(input => input.disabled = true);
}
...
document.querySelector('#resultOrNextButton')?.addEventListener('click', buttonFunction);
//一番左のボタンの処理
...
// モード選択
document.querySelector('#normalButton')?.addEventListener('click', normalMode);
